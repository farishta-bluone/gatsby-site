...
export default {
  ...
  computed: {
    validateFields() {
      if (
        this.coil.pickled_thickness &&
        this.coil.pickled_width &&
        this.coil.pickled_weight &&
        this.coil.pickling_operator &&
        this.coil.pickling_od
      ) {
        return true;
      } else return false;
    },
  ...
  methods: {
    async saveCoil() {
      ...
      data.push({
        ...
        pickling_notes: this.coil.pickling_notes
          ? this.coil.pickling_notes
          : "",
        status: status,
        id: this.coil.ID,
